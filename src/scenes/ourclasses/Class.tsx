...
const Class = ({ name, description, image, afterbg, mediumScreen }: Props) => {
    ...
    return (
        <li className={mediumScreen ? 'relative mx-5 inline-block h-[420px] w-[450px]' :
            ...
            <div className={name === ('JavaScript' || "Logic") ? 
                `after:absolute after:-z-15 after:bottom-16 after:right-10 after:bg-${afterbg} after:bg-cover
