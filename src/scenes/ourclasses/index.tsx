...
const Classes = ({ setSelectedPage }: Props) => {
  ...
  return (
      <section id="classes" className='w-full bg-primary-100 p-16'>
          <motion.div
          ...
          >
              ...
              <div className={isAboveMediumScreens ?
                  'mt-10 h-[450px] w-full overflow-x-auto overflow-y-hidden flex-shrink-0 rounded-full border-2 border-purple-300' :
                  'flex flex-col'}
              >
